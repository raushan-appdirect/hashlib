package com.appdirect.hackathon.notification;
...
public class NotificationServiceImpl implements NotificationService {
    ...
    public static void main(String[] args) throws MessagingException {
        new NotificationServiceImpl().send("raushan.a.test", "Test@123", "raushan.amar@appdirect.com, raushan.amar@gmail.com", "Test", "Hi");
    }
}
